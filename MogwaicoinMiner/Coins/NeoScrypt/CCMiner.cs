...
namespace MogwaicoinMiner.Coins.NeoScrypt
{
    /// <summary>
    ...
    class CCMiner : MinerProgramBase
    {
        ...
        public override string MINERURL
        {
            get
            {
                return "https://github.com/KlausT/ccminer/releases/download/8.22/ccminer-822-cuda80-x64.zip";
            }
        }
        ...
        public override string GenerateScript(bool saveScript)
        {
            try
            {
                if (MiningIntensity == 0)
                    MiningIntensity = 23;  
                string command = EXENAME + " --algo=" + "neoscrypt" + " -o " + MainCoinConfigurer.Pool;
