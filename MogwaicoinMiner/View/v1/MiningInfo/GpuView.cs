            ...
            try
            {
                ...
                if (GpuData != null)
                {
                    if (GpuData.Make == CardMake.Nvidia)
                        pbCardType.Image = MogwaicoinMiner.Properties.Resources.nvidia3;
                    else if (GpuData.Make == CardMake.Amd)
                        pbCardType.Image = MogwaicoinMiner.Properties.Resources.amd5;
                    else if (GpuData.Make == CardMake.CPU)
                        pbCardType.Image = MogwaicoinMiner.Properties.Resources.cpu;
                    else
                        pbCardType.Image = MogwaicoinMiner.Properties.Resources.gpu;
