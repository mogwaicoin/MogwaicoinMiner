using MogwaicoinMiner.Model.FileIO;
using System;
...
namespace MogwaicoinMiner.Model
{
    /// <summary>
    /// Todo:
    ...
    {
        const string minerfileName = "mogwaicoinminer.json";
        string m_filepath = "";
        ...
        {
            IFileIO fileio = null;
            fileio = new AppData("MogwaicoinMiner", minerfileName);
            if (fileio.Verify())
                return fileio;
            fileio = new LocalFolder("MogwaicoinMiner", minerfileName);
            if (fileio.Verify())
                return fileio;
